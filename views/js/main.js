...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    //store queried DOM elements once
    ...
    //change style using percentage, without querying any layout
...
function updatePositions() {
  ...
  //query layout once outside the for-loop
  phaseCalc = Math.sin((document.body.scrollTop / 1250));
  //batch style changes without querying layout again in the for-loop
